    ...
    while ( $the_query->have_posts() ) : 
       ...
       $theid = get_the_ID() ;?>
        ...
        <?php echo get_the_post_thumbnail( $page->ID, 'thumbnail' ); ?>
          <h4><?php the_title(); ?></h4>
          <p><?php the_content(); ?></p>
         <a href="/scooters?book=<?php the_title(); ?>&service=<?php echo $booking_service; ?>" class="cta">Book Now<span class="ti-angle-right"></a>
         <a href="/scooters" style="display:none;" class="hidden_cta">Back<span class="ti-angle-right"></a>
        </div>
   <? endwhile; 
    wp_reset_postdata(); 
else: 
