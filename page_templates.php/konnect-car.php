<?php
/*
 * Template Name: Konnect Car
 * description: Konnect Template Car
 */
get_header(); ?>
...
<div class="page-content">
        ...
        <h2 class="sc_item_title sc_title_title sc_align_left sc_item_title_style_extra"><span class="sc_item_title_text">Want to Rent a Car?</span></h2>
      ...
      <div class="section-row">
        <?php echo do_shortcode( '[custom_cars_shortcode]' ); ?>
        <?php 
        $booking = $_GET['book'];
            if($booking != ''){
                 echo '<style>
